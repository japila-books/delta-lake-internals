...
*OptimisticTransactionImpl* is an <<contract, extension>> of the xref:TransactionalWrite.adoc[] for <<implementations, optimistic transactions>> that can be <<commit, committed>>.
