...
`MergeOutputGeneration` is an extension of the [MergeIntoCommandBase](MergeIntoCommandBase.md) abstraction for [merge output generators](#implementations) with logic to transform the merge clauses into expressions that can be evaluated to obtain the (possibly optimized) output of the [MERGE INTO command](index.md).
...
---------------------|--------
[WHEN MATCHED THEN UPDATE](DeltaMergeIntoMatchedUpdateClause.md) | <ol><li>All [DeltaMergeAction](DeltaMergeIntoClause.md#actions)s<li>Expression to increment metrics:<ul><li>[number of updated rows](MergeIntoCommandBase.md#numTargetRowsUpdated)<li>[number of rows updated by a matched clause](MergeIntoCommandBase.md#numTargetRowsMatchedUpdated)</ul>Returns`false` literal<li> [update_postimage](../../change-data-feed/CDCReader.md#CDC_TYPE_UPDATE_POSTIMAGE) literal (when the given `cdcEnabled` flag enabled) or none</ol>
[WHEN NOT MATCHED BY SOURCE THEN UPDATE](DeltaMergeIntoNotMatchedBySourceUpdateClause.md) | <ol><li>All [DeltaMergeAction](DeltaMergeIntoClause.md#actions)s<li>Expression to increment metrics:<ul><li>[number of updated rows](MergeIntoCommandBase.md#numTargetRowsUpdated)<li>[number of rows updated by a not matched by source clause](MergeIntoCommandBase.md#numTargetRowsNotMatchedBySourceUpdated)</ul>Returns`false` literal<li>[update_postimage](../../change-data-feed/CDCReader.md#CDC_TYPE_UPDATE_POSTIMAGE) literal (when the given `cdcEnabled` flag enabled) or none</ol>
[WHEN MATCHED DELETE](DeltaMergeIntoMatchedDeleteClause.md) | <ol><li>All [DeltaMergeAction](DeltaMergeIntoClause.md#actions)s<li>Expression to increment metrics (when `shouldCountDeletedRows` enabled) or `true` literal:<ul><li>[number of deleted rows](MergeIntoCommandBase.md#numTargetRowsDeleted)<li>[number of rows deleted by a matched clause](MergeIntoCommandBase.md#numTargetRowsMatchedDeleted)</ul>Returns`true` literal<li>[delete](../../change-data-feed/CDCReader.md#CDC_TYPE_DELETE) literal (when the given `cdcEnabled` flag enabled) or none</ol>
[WHEN NOT MATCHED BY SOURCE THEN DELETE](DeltaMergeIntoNotMatchedBySourceDeleteClause.md) | <ol><li>All [DeltaMergeAction](DeltaMergeIntoClause.md#actions)s<li>Expression to increment metrics (when `shouldCountDeletedRows` enabled) or `true` literal:<ul><li>[number of deleted rows](MergeIntoCommandBase.md#numTargetRowsDeleted)<li>[number of rows deleted by a not matched by source clause](MergeIntoCommandBase.md#numTargetRowsNotMatchedBySourceDeleted)</ul>Returns `true` literal<li>[delete](../../change-data-feed/CDCReader.md#CDC_TYPE_DELETE) literal (when the given `cdcEnabled` flag enabled) or none</ol>
[WHEN NOT MATCHED THEN INSERT](DeltaMergeIntoNotMatchedInsertClause.md) | <ol><li>All [DeltaMergeAction](DeltaMergeIntoClause.md#actions)s<li>Expression to increment metrics:<ul><li>[number of inserted rows](MergeIntoCommandBase.md#numTargetRowsInserted)</ul>Returns `false` literal<li>[insert](../../change-data-feed/CDCReader.md#CDC_TYPE_INSERT) literal (when the given `cdcEnabled` flag enabled) or none</ol>
