...
The demo shows how to differentiate commits of a write batch query using [userMetadata](../options/index.md#userMetadata) option.
...
You're going to use [userMetadata](../options/index.md#userMetadata) option for a custom user-defined historical marker (e.g. to know when this extra append happended in the life of the Delta table).
