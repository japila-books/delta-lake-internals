...
**spark.databricks.delta.import.batchSize.statsCollection** (internal) is the number of files per batch for stats collection during [import](ConvertToDeltaCommand.md#performConvert-schemaBatchSize).
